(ns user
  ...
  (:require
    ...
    [io.github.kit.gif2html.core :refer [start-app]]))
...
(defn dev-prep!
  ...
  (integrant.repl/set-prep! (fn []
                              (-> (io.github.kit.gif2html.config/system-config {:profile :dev})
                                  (ig/prep)))))

(defn test-prep!
  []
  (integrant.repl/set-prep! (fn []
                              (-> (io.github.kit.gif2html.config/system-config {:profile :test})
                                  (ig/prep)))))
